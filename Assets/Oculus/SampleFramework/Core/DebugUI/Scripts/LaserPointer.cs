...
public class LaserPointer : OVRCursor
{
    ...
    private Vector3 modelPlacementPos;
    Transform childObj;
    ...
    private void Start()
    {
        ...
        controller.transform.position = Vector3.zero;
         ...
         childObj = controller.transform.Find("GearVrControllerModel");
    ...
    private void LateUpdate()
    {
        ...
        controller.transform.rotation = OVRInput.GetLocalControllerRotation(OVRInput.Controller.RTrackedRemote); //Quaternion.Slerp(transform.rotation, target2, Time.deltaTime * smooth);
    ...
    private void UpdateLaserBeam(Vector3 start, Vector3 end)
    {
        ...
        //Debug.Log(end.x + " " + end.y + " " + end.z);
        controller.transform.position = start;

        modelPlacementPos = end;
    ...
    public Vector3 getModelPlacementPosition()
    {
        return modelPlacementPos;
    }
